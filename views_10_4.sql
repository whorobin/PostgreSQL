...
-- view hocche (amra full ekta querie k ekta nama dara view kore rakhte pari, porobortite jodi kokhono oi querie er dorkar hoy tahole name ta dilei kaj hoye jabe. full quary notun kore likhte hobe na)

-- 1) table check 
SELECT * FROM employeees;

-- 2) department er avarage salary
SELECT department_name, avg(salary) FROM employeees GROUP BY department_name;
...
-- 4) view er name use kore output dekha
